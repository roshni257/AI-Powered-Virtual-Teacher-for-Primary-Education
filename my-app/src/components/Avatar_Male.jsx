...
export function Avatar_Male(props) {
  ...
  const { scene } = useGLTF('/models/teacher_male.glb')
  const idleFBX = useFBX('/animations/Idle_Standing_male.fbx')
  const talkingFBX = useFBX('/animations/Talking_Standing_male.fbx')
...
useGLTF.preload('/models/teacher_male.glb')
useFBX.preload('/animations/Idle_Standing_male.fbx')
useFBX.preload('/animations/Talking_Standing_male.fbx')